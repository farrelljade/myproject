                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    @if($customer->trashed())
                                        <form action="{{ route('admin.restore', $customer->id) }}" method="POST" class="inline">
                                            @csrf
                                            <button type="submit" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-2 py-2 text-center">Restore</button>
                                        </form>
                                    @endif
                                </td>
                            </tr>
