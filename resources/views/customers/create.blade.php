  ...
  <form action="{{ route('customers.store') }}" method="post">
    ...
    <div class="space-y-12">
      <div class="border-b border-gray-900/10 pb-12">
        ...
        <p class="mt-1 text-sm leading-6 text-gray-600">Invoice address required</p>
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div class="col-span-full">
            ...
            <div class="mt-2">
              <input type="text" name="address" id="address" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Start typing and select your address">
            </div>
          </div>
          <div class="sm:col-span-2">
            <label for="number" class="block text-sm font-medium leading-6 text-gray-900">Contact number</label>
            <div class="mt-2">
              <input type="text" name="number" id="number" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
          </div>     
        </div>
      </div>
