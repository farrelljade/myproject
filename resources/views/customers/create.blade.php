      ...
      <div class="border-b border-gray-900/10 pb-12">
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <div class="sm:col-span-3">
            ...
            @error('name')
              <div class="text-red-700 px-1.5 py-1.5">company name required</div>  
            @enderror
          </div>
          <div class="sm:col-span-4">
            ...
            @error('email')
              <div class="text-red-700 px-1.5 py-1.5 rounded relative">email address required</div>  
            @enderror
          </div>
          <div class="col-span-full">
            ...
            @error('address')
              <div class="text-red-700 px-1.5 py-1.5" role="alert">invoice address required</div>  
            @enderror
          </div>
          <div class="sm:col-span-2">
            ...
            @error('number')
              <div class="text-red-700 px-1.5 py-1.5">contact number required</div> 
            @enderror
          </div>     
        </div>
      </div>
